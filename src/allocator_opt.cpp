...
size_t allocatorOpt::evaluate_model() {
    ...
    std::cout << "alloc_mgr.get_reserved_size(): " << alloc_mgr.get_reserved_size() << std::endl;
...
void allocatorOpt::search_kMinBlockSize() {
    for (auto candidate : kMinBlockSize_candidates) {
        ...
        std::cout << "allocatorConf::get_kMinBlockSize(): " << allocatorConf::get_kMinBlockSize() << std::endl;
        auto reserved_size = evaluate_model();
        std::cout << "evaluate_model(): " << evaluate_model() << std::endl;
